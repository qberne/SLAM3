    function addParticipation(idCours, idEnfant) {                
        var filterDataRequest = $.ajax({
            ...
            type: 'GET',
            data: 'action=2&idEnfant='+ idEnfant + '&idCours='+ idCours,
    ...
    function delParticipation(idCours, idEnfant) {                
        var filterDataRequest = $.ajax({
            url: '../controller/attribution-cours.php',
            type: 'GET',
            data: 'action=3&idEnfant='+ idEnfant + '&idCours='+ idCours
        });
    ...
    function jsRecupCours(element){
        ...
        if(val !== "") {
            ...
            var dispo = '<h1>Cours disponnibles</h1><table border=1 id="tableauConsultation"><tr><th>Niveau</th><th>Jour</th><th>Heure</th><th>Nb</th><th>Com</th><th>Inscrire</th></tr>';
            var inscrit = '<h1>Cours inscrits</h1><table border=1 id="tableauConsultation"><tr><th>Niveau</th><th>Jour</th><th>Heure</th><th>Nb</th><th>Com</th><th>Désinscrire</th></tr>';           
            ...
            filterDataRequest.done(function(data) {                
                ...
                $.each(data[2], function(index, value) {
                    $('#infoEnfant').append('<table><tr><th>Prenom :</th><td>'+value["PRENOM_ENFANT"]+'</td></tr><tr><th>Date de naissance :</th><td>'+value["DATE_NAISSANCE"]+'</td></tr><tr><th>Sexe :</th><td>'+value["SEXE_ENFANT"]+'</td></tr><tr><th>Téléphone :</th><td>'+value["TEL_ENFANT"]+'</td></tr><tr><th>Niveau :</th><td>'+value["LIBELLE_NIVEAU"]+'</td></tr></table>');
                });
            });
